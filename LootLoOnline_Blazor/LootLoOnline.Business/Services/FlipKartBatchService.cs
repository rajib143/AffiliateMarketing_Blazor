...
namespace LootLoOnline.Business.Services
{
    ...
    {
        public IDataRepository<OfferProduct> offerProductRepository;
        public IDataRepository<Log> logRepository;
        ...
        public FlipKartBatchService(IConfiguration config, IMemoryCache memoryCache)
        {
            ...
            //offerProductRepository = new OfferProductRepository(config, memoryCache);
            //logRepository = new FlipKartDealsOftheDayRepo(config, memoryCache);
